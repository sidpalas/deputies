...
variable "run_mode" {
  description = "Deputies run mode for the control-plane container when topology_mode is combined. Split topology uses api and worker run modes automatically."
  type        = string
}

variable "desired_count" {
  description = "Desired ECS task count for combined topology."
  type        = number
}
