...
- `pnpm check` runs formatting, lint, package typechecks, and package unit tests. `mise run //:check` is the canonical pre-push check and additionally validates infrastructure; neither command runs Playwright E2E tests.
