...
const enabled = process.env.RUN_REAL_OPENCOMPUTER_PROVIDER_UAT === 'true';
const hasRequiredEnv = Boolean(
  process.env.OPENCOMPUTER_API_KEY && (process.env.OPENCOMPUTER_SNAPSHOT || process.env.OPENCOMPUTER_TEMPLATE),
);
...
function openComputerOptions(): OpenComputerSandboxProviderOptions {
  ...
  if (process.env.OPENCOMPUTER_TEMPLATE) options.template = process.env.OPENCOMPUTER_TEMPLATE;
